package assignment4;
	...
	public class Hashmap
	{
	    public static void main(String args[])
	    {
	        ...
	        m1.put(1,"Pooja kumari"); 
	        m1.put(2,"Rakhi trivedi");   
	        m1.put(3,"Tanisha panday");
	        m1.put(4,"Ritu dubey");
	        m1.put(5,"Rashi sharma");
	        m1.put(6,"shruti dubey"); 
	       ...
	       // Here we print the Initial Map
	       System.out.println("Initial Map is:-"+m2);

	       m2.replace(7,"priya devi");
	       ...
	       // 8. size() method is used to returns the number of entries in the map.
	           ...
	           System.out.println("Mukesh Kumar is present in Map M1:- "+m1.containsValue("Pooja"));
	           System.out.println("Deepak Kumar is present in Map M1:- "+m1.containsValue("Rakhi"));
